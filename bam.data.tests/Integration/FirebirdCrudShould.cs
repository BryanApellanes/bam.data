...
[IntegrationTestMenu("Firebird CRUD should", "fb")]
public class FirebirdCrudShould : IntegrationTestMenuContainer
{
    ...
    private static FirebirdSqlDatabase SetupDb()
    {
        ...
        System.Console.WriteLine($"[firebird] TryEnsureSchema returned: {schemaStatus}");
